...
function EDITOR:Replace( str, replacewith )
	...
	if not use_patterns then
		str = WireLib.PatternEscape(str)
		replacewith = WireLib.ReplacePatternEscape(replacewith)
	end
...
function EDITOR:FindAllWords( str )
	...
	local pattern = "%f[%w_]()" .. WireLib.PatternEscape(str) .. "%f[^%w_]()"
...
local function FindFunctions( self, has_colon, word )
	...
	word = WireLib.PatternEscape(word)
